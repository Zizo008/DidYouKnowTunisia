...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="username" class="form-control" placeholder="Insert username" value="<?php echo $username; ?>">
                <span class="help-block"><?php echo $username_err; ?></span>
            </div>    
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                
                <input type="password" placeholder="Insert password" name="password" class="form-control" value="<?php echo $password; ?>">
            ...
            <p>Already have an account? <a id="reg" href="log.php">Login here</a>.</p>
        </form>
<?php
include "connect.php"
?>
